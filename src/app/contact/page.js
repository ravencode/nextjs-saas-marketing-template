    ...
    <div className="bg-white">
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-5 max-w-xl mx-auto text-xl text-gray-500">Have questions? We're here to help you.</p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-3 text-lg text-gray-500">We'll get back to you as soon as possible.</p>
          ...
          <div>
            ...
            <p className="mt-3 text-lg text-gray-500">Prefer to reach out directly? Use any of these methods.</p>
